...
public static class HierarchyFolderExtensions
{
	...
	/// </summary>
	static HierarchyFolderExtensions()
	{
	...
	/// <summary>
	/// Gets parent closest to root up the parent chain that is not a Hierarchy Folder.
	/// </summary>
	/// <param name="gameObject"> GameObject whose parent chain to check. </param>
	/// <returns> First parent GameObject that optionally doesn't contain the HierarchyFolder component, or null if has no such parent. </returns>
	[CanBeNull]
	...
	/// </summary>
	/// <param name="gameObject"> GameObject whose parent chain to check. </param>
	/// <returns> First parent GameObject that doesn't contain the HierarchyFolder component, or null if has no such parent. </returns>
	[CanBeNull]
	...
	/// <returns> First parent GameObject that doesn't contain the HierarchyFolder component, or null if has no such parent. </returns>
	[CanBeNull]
	private static void GetParents([NotNull]Transform transform, Stack<Transform> parentStack)
	{
		var parent = transform.parent;
		while(parent != null)
		{
